...
/*====== CheckOut Page ======*/
    ...
    $('#different_address_tick').on('click' , function(){
      var checkbox_ship=document.getElementById('ship_to_different_address');
        if(checkbox_ship.checked == true)
        {
          checkbox_ship.checked = false;
        }
        else{
          checkbox_ship.checked = true;
        }
    });
